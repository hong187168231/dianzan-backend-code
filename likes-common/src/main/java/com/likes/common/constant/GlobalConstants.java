...
public interface GlobalConstants {
    ...
    public static final String USER_SIGNIN_ = "MEM:USER_SIGNIN_";
    ...
    /**
     * 提现订单类型   1待处理 2已锁定 3  已取消 4 已拒绝 5 已成功
     */
    public static final Integer PAY_CASH_STATUS_PENDING = 1;
    public static final Integer PAY_CASH_STATUS_LOCK = 2;
    public static final Integer PAY_CASH_STATUS_CANCEL = 3;
    public static final Integer PAY_CASH_STATUS_REJECT = 4;
    public static final Integer PAY_CASH_STATUS_SUCCEED = 5;
